      ...
      j = class e extends EventTarget {
        ...
        #a(e, t) {
          ...
          let n = this[d]?.dispatcher?.webSocketOptions?.maxPayloadSize,
            r = new C(this, t, { maxPayloadSize: n });
          (r.on(`drain`, M),
            r.on(`error`, N.bind(this)),
            (e.socket.ws = this),
            (this[h] = r),
...
var Nn = o((e, t) => {
  ...
  ur = o((e, t) => {
    ...
    var r = new (lr())(),
      ...
      O = (e, t) => (o(`replaceStars`, e, t), e.trim().replace(c[u.STAR], ``)),
      k = (e, t) => (
        o(`replaceGTE0`, e, t),
